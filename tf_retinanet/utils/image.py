...
def adjust_transform_for_image(transform, image, relative_translation):
    ...
    The linear part of the transformation will adjusted so that the origin of the transformation
    ...
    result = change_transform_origin(
        transform=transform,
...
class TransformParameters:
    ...
    Args:
        ...
        relative_translation:   If true (the default), interpret translation as a factor of the
                                    image size.
...
def apply_transform(matrix, image, params):
    ...
    Mathematically speaking, that means that the matrix is a transformation from the transformed
        image space to the original image space.
...
def compute_resize_scale(image_shape, min_side=800, max_side=1333):
    ...
    Args:
        ...
        max_side: If after resizing the image's max side is above max_side, resize until the max
                    side is equal to max_side.
