...
def make_training_config(args):
    """
    Create training config by parsing args from command line and YAML config file, filling the
...
def make_evaluation_config(args):
    """
    Create evaluation config by parsing args from command line and YAML config file, filling the
        rest with default values.
...
def make_conversion_config(args):
    """
    Create conversion config by parsing args from command line and YAML config file, filling the
        rest with default values.
    ...
    # Additional config;
    # start from this so it can be overwritten by the other command line options.
    if args.o:
        config = parse_additional_options(config, args.o)
...
def make_debug_config(args):
    """
    Create debug config by parsing args from command line and YAML config file, filling the rest
        with default values.
