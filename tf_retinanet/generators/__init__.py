...
def preprocess_config(config):
    ...
    """
    # Set the tranform generator class.
...
def get_generators(config, submodels_manager, preprocess_image, **kwargs):
    ...
    Imports generators from an external package,
        ...
        The link between submodels and generators depends on the used generator,
        hence they are created together in the external package.
